    ...
    $.fn.tDatePicker = function(pr_el, options) {
        ...
        function getTableCalendar(pr_el, pr_date_utc) {
            if ($(pr_el).find('.t-datepicker-day').length !== 0) {
                ...
                $(pr_el).find('.t-dates').parent().append('<div style="direction:rtl" class="t-datepicker-day' + checkNumCalendar + '"><div class="header-cal"><div class="con-flx"><span class="dp-close" style="margin-left: 12px;">&#10005;</span><span>حدد تاريخ</span></div></div>' + convertArrayToString(dataTheme) + '</div>')
				}
				else{
